...
<div id="cnt">
	...
	<div id="rel">
		<h3 style="text-align: center;font-weight: bold;">Questions By You</h3>
		<br><br><br>
		<div id="qnss">
...
<hr style="border: 1px solid black;">
	<div id="qn" class="row">
			<h3 style="font-weight: bold;">Have Another Question?</h3>
...
<script>
	...
	function updt() {
		$.post('action.php',{updte : 0,uid: <?php echo $uid ?>},function(data)
            {
            	$('#qnss').html(data);
            });
	}
